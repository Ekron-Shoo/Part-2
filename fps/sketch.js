...
class TheScene extends Physijs.Scene {
  ...
  constructor (renderer, aCamera) {
    ...
    this.index = 0;
    this.maxBullets = 20;
    this.actualAmmo = 50; //Balas totales antes de acabar el juego
    this.score = 0;
    this.lastScore = 0;
    this.level = 1;
  ...
  createHUD() {
    ...
    ammo.style.top = 600 + 'px';
    ammo.style.left = 20 + 'px';
    ammo.style.fontSize = 30 + 'px';
    ...
    level.style.top = 560 + 'px';
    level.style.left = 20 + 'px';
    level.style.fontSize = 30 + 'px';
  ...
  endGame() {
    ...
    var result = str.link("https://ekron-shoo.github.io/Part-3/");
    document.getElementById("demo").innerHTML = result;

    instructions.innerHTML = "Total Score : " + this.score + ", Prees Esc And " + result;
  }
